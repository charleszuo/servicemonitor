...
public interface ConstantName {
	...
	String TEMPLATE_JAVA_DYNAMIC_PROXY = "templates/system/JavaDynamicProxy.vm";

	String TEMPLATE_CGLIB_DYNAMIC_PROXY = "templates/system/CglibDynamicProxy.vm";

	String TEMPLATE_ADVISOR = "templates/system/Advisor.vm";
	
	String TEMPLATE_LOG_ADVISOR = "templates/system/LogAdvisor.vm";
	
	String TEMPLATE_SERVICE_MONITOR = "templates/system/ServiceMointor.vm";
	
	String TEMPLATE_SERVICE_MONITOR_FACTORY = "templates/system/ServiceMonitorFactory.vm";
	
	String TEMPLATE_MONITOR_BASIC_INFO = "templates/system/MonitorBasicInfo.vm";
	
	String TEMPLATE_IP_UTIL = "templates/system/IPUtil.vm";
	
	String TEMPLATE_SEQ_NUM = "templates/system/SequenceService.vm";
	
	String M2_REPO = "/home/charles/.m2/repository";

	String TARGET_WORK_SPACE = "/home/charles/workspace/xiaonei-share/xn_share_web";
