...
public class SearchCallHierarchy {
	...
	// 按照被调用方法搜索
	public void searchCallHierarchy(String method) {
	...
	public static void main(String[] args){
		SearchCallHierarchy.getInstance().searchCallHierarchy("com/xiaonei/search2/condition/FilterSearchCondition addGender (Ljava/lang/String;)V non-static");
	}
}
