...
public class TemplateGenerator {
	...
	public static void generateClassFile(String inputClassName,
		...
		try {
			...
			String targetClassName = inputClassName.replace(Constants.SEPARATOR_SLASH,
					Constants.SEPARATOR_POINT);
			...
			if (methodDescriptionSet != null) {
				for (Iterator<DependentDescriptor> it = methodDescriptionSet
					...
					if (classMethodDescription
							.contains(Constants.TEMPLATE_CONSTANT_GET_INSTANCE) && Constants.TEMPLATE_SINGLETON_CLASS.equals(templateFile)) {
						continue;
					}
