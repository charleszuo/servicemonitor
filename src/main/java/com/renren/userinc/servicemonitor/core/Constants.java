...
public class Constants {
	...
	public static final String COMPILE_AND_PACKAGE_GENERATED_FILES_SCRIPT = SERVICE_MONITOR_TOOL_DIR + "/src/main/java/shellscript/compile_package_generated_files.sh";
	...
	public static final String LOG_ROUND_INFO = "roundInfo.log";
	
	public static final String LOG_LEAF = "leaf.log";
	
	public static final String LOG_WHITE_LIST = "whiteList.log";
	
	public static final String LOG_RESULT = "generateResult.log";
	
	public static final String LOG_TOP_NODES = "topNodes.log";
	
	public static final String FILE_META_DATA = "metaData.txt";
	...
	public static final String TEMPLATE_SYSTEM_FILES = "JavaDynamicProxy,CglibDynamicProxy,Advice,LogAdvice,LogAdvice,RemoteAlertAdvice,ServiceMonitor,ServiceMonitorFactory,MonitorInfoBean,IPService,SequenceService,MetaDataService";
	...
	public static final String META_DATA_DATASOURCE = "renren_alert";
}
